...
astroidsServerApp.controller('MainController', ['$scope',
    function ($scope) {
    }]);

astroidsServerApp.controller('AdminController', ['$scope',
    function ($scope) {
    }]);

astroidsServerApp.controller('LanguageController', ['$scope', '$translate',
...
astroidsServerApp.controller('MenuController', ['$scope',
    function ($scope) {
    }]);

astroidsServerApp.controller('LoginController', ['$scope', '$location', 'AuthenticationSharedService',
...
astroidsServerApp.controller('LogoutController', ['$location', 'AuthenticationSharedService',
...
astroidsServerApp.controller('SettingsController', ['$scope', 'Account',
...
astroidsServerApp.controller('PasswordController', ['$scope', 'Password',
...
astroidsServerApp.controller('SessionsController', ['$scope', 'resolvedSessions', 'Sessions',
 ...
 astroidsServerApp.controller('TrackerController', ['$scope',
    function ($scope) {
...
astroidsServerApp.controller('MetricsController', ['$scope', 'MetricsService', 'HealthCheckService', 'ThreadDumpService',
...
astroidsServerApp.controller('LogsController', ['$scope', 'resolvedLogs', 'LogsService',
...
astroidsServerApp.controller('AuditsController', ['$scope', '$translate', '$filter', 'AuditsService',
