...
import fr.octo.astroids.server.config.Constants;
...
public class Application {
     ...
     * "-javaagent:spring_loaded/springloaded.jar -noverify -Dspringloaded=plugins=fr.octo.astroids.server.config.reload.instrument.JHipsterLoadtimeInstrumentationPlugin"
     */
