...
import fr.octo.astroids.server.config.reload.instrument.hibernate.JHipsterEntityManagerFactoryWrapper;
...
public class LiquibaseReloader {
    ...
    public void reloadEvent(List<Class> entities) {
        ...
        try {
            final String packagesToScan = "fr.octo.astroids.server.domain";
