...
import fr.octo.astroids.server.config.reload.condition.ConditionalOnSpringLoaded;
import fr.octo.astroids.server.security.*;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public UserDetailsService userDetailsService() {
        return new fr.octo.astroids.server.security.UserDetailsService();
    }
